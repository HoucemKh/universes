<?php
 ...
 if ( isset($_POST['btn-signup']) ) {
  ...
  if( !$error ) {
   ...
   $query = "INSERT INTO users(userName,userEmail,userPass,mobilephone) VALUES('$name','$email','$pass','$mobile')";
...
<body>
   ...
   ?>
                ...
                <label>Phone Number</label>
								<input type="text" Name="mobile" placeholder="Phone Number" required="" value="<?php echo $mobile ?>" >
                </div>
			...
			<div class="footer">
		<p> &copy; 2017 AndroidLand. All Rights Reserved<a href="http://w3layouts.com" target="_blank"></a></p>
	</div>
